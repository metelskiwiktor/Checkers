...
public class WhitePiecePossibleMoveTest extends FigureMoveTestTemplate {
    ...
    public void test01() {
        ...
        //WHEN
        Set<Field> possibleMoves = PossibleMoveFacade.whitePieceMove().move(from);
    ...
    @DisplayName("White piece should move 2 fields to the right up, left up, left down or right down")
    @Test
    public void test02() {
        //GIVEN
        loadStandingParameters(3, 3);
    ...
    @DisplayName("White piece shouldn't move 1 field to the right down or left down")
    @Test
    public void test03() {
        //GIVEN
        loadStandingParameters(3, 3);
    ...
    @DisplayName("White piece shouldn't move straight up, left, down or right")
    @Test
    public void test04() {
        //GIVEN
        loadStandingParameters(3, 3);
    ...
    @DisplayName("White piece shouldn't move 3 fields to the right up, left up, left down or right down")
    @Test
    public void test05() {
        //GIVEN
    ...
    @DisplayName("White piece shouldn't move 1 field to the left up, right up being on the up edge")
    @Test
    public void test06() {
        //GIVEN
    ...
    @DisplayName("White piece shouldn't move 2 fields to the left down, right down being on the down edge")
    @Test
    public void test07() {
        //GIVEN
    ...
    @DisplayName("White piece shouldn't move 1 field to the right up being on the right edge")
    @Test
    public void test08() {
        //GIVEN
    ...
    @DisplayName("White piece shouldn't move 1 field to the left up being on the left edge")
    @Test
    public void test09() {
        //GIVEN
